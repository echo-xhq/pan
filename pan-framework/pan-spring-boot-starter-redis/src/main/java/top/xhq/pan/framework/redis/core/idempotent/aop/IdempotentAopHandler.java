package top.xhq.pan.framework.redis.core.idempotent.aop;
...
import top.xhq.pan.exception.CustomException;
import top.xhq.pan.framework.redis.core.idempotent.annotation.Idempotent;
import top.xhq.pan.framework.redis.core.utils.RedisUtil;
import top.xhq.pan.framework.redis.core.utils.TokenUtil;
...
class IdempotentAopHandler {
     ...
     */
    @Pointcut("@annotation(top.xhq.pan.framework.redis.core.idempotent.annotation.Idempotent)")
